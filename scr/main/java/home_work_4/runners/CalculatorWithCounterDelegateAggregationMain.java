...
import home_work_4.calcs.additional.CalculatorWithCounterAutoAggregation;
import home_work_4.calcs.simple.CalculatorWithMathCopy;

public class CalculatorWithCounterDelegateAggregationMain {
    public static void main(String[] args) {
        CalculatorWithCounterAutoAggregation calculator = new CalculatorWithCounterAutoAggregation(new CalculatorWithMathCopy());
